...
@implementation UIImage (CXDRoundImage)

- (UIImage *)CXD_setradius:(CGFloat)radius size:(CGSize)size {
    return [UIImage CXD_setCXDRadius:CXDRadiusMake(radius, radius, radius, radius) image:self size:size borderColor:nil borderWidth:0 backgroundColor:nil withContentMode:UIViewContentModeScaleAspectFill];
}

- (UIImage *)CXD_setradius:(CGFloat)radius size:(CGSize)size contentMode:(UIViewContentMode)contentMode {
    return [UIImage CXD_setCXDRadius:CXDRadiusMake(radius, radius, radius, radius) image:self size:size borderColor:nil borderWidth:0 backgroundColor:nil withContentMode:contentMode];
}

+ (UIImage *)CXD_setRadius:(CGFloat)radius size:(CGSize)size borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor {
    return [UIImage CXD_setCXDRadius:CXDRadiusMake(radius, radius, radius, radius) image:nil size:size borderColor:borderColor borderWidth:borderWidth backgroundColor:backgroundColor withContentMode:UIViewContentModeScaleToFill];
}
...
+ (UIImage *)CXD_setCXDRadius:(CXDRadius)radius image:(UIImage *)image size:(CGSize)size borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor withContentMode:(UIViewContentMode)contentMode {
    ...
    radius = [UIImage transformationCXDRadius:radius size:size borderWidth:borderWidth];
...
+ (CXDRadius)transformationCXDRadius:(CXDRadius)radius size:(CGSize)size borderWidth:(CGFloat)borderWidth {
